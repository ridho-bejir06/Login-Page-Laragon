    ...
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="Masukkan nama lengkap" value="<?php echo e(old('name')); ?>" required>
            </div>
...
</html><?php /**PATH C:\laragon\www\latihandatabase2\resources\views/auth/register.blade.php ENDPATH**/ ?>